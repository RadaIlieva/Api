            ...
            else
            {
                ...
                do
                {
                    ...
                    using (var httpClient = new HttpClient())
                    {
                        ...
                        IOrganizationConsoleService organizationService = new OrganizationConsoleService(crud, apiUrl, displayInfoConsole, apiStatisticConnection, displayStatisticsMethods);
